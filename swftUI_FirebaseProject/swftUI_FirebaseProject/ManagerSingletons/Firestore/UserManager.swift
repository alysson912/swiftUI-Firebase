...
final class UserManager {
    ...
    func addUserFavoriteProducts(userId: String, productId: Int) async throws {
        ...
        let documentId = document.documentID // doc em branco
        
        // 1- pegando os dados para mandar para o firebase
        let data: [String : Any] = [
        ...
        // 2- dentro de coleção user, cria uma nova coleção "favorite_products", agora atribua um ID aleatorio, agora defina os dados desse documento
